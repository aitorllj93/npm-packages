...
1. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) and [clone](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/cloning-a-repository) the [repository](https://github.com/d3v0ps/npm-packages)
...
5. Run `npm run build` and then run tests with `npm test`
6. For package changes, add docs inside the `/packages/*/README.md`.
